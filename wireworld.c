...
{
	s.wire = register_blocktype(BLOCK_INVALID, "wire", &convert_wire, &trigger_wire, NULL, &physics_wire, false);
	s.wire3d = register_blocktype(BLOCK_INVALID, "wire3d", &convert_wire, &trigger_wire, NULL, &physics_wire3d, false);
}
