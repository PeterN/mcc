...
all: $(MCCO) $(WWO) $(SPLEEFO) $(TNTO) $(HBO) $(IRCO) $(ALO) $(IPCO) $(SETRANKO) $(BANIPO) $(PORTALO) $(DOORSO) $(ZOMBIEO) $(SIGNSO) $(NOHACKSO) $(NPCTESTO) $(BOOKO) $(IMAGEO)

clean:
	rm -f *.d $(LIBOBJ) $(MCCOBJ) $(LIBO) $(MCCO) $(SPLEEFOBJ) $(SPLEEFO) $(WWOBJ) $(WWO) $(TNTOBJ) $(TNTO) $(HBOBJ) $(HBO) $(IRCOBJ) $(IRCO) $(ALOBJ) $(ALO) $(IPCOBJ) $(IPCO) $(SETRANKOBJ) $(SETRANKO) $(BANIPOBJ) $(BANIPO) $(PORTALOBJ) $(PORTALO) $(DOORSOBJ) $(DOORSO) $(ZOMBIEOBJ) $(ZOMBIEO) $(SIGNSO) $(SIGNSOBJ) $(NOHACKSO) $(NOHACKSOBJ) $(NPCTESTO) $(NPCTESTOBJ) $(BOOKO) $(BOOKOBJ) $(IMAGEOBJ)

SOURCES = $(LIBSRC) $(MCCSRC) $(SPLEEFSRC) $(WWSRC) $(TNTSRC) $(HBSRC) $(IRCSRC) $(ALSRC) $(IPCSRC) $(SETRANKSRC) $(BANIPSRC) $(PORTALSRC) $(DOORSSRC) $(ZOMBIESRC) $(SIGNSSRC) $(NOHACKSRC) $(NPCTESTSRC) $(BOOKSRC) $(IMAGESRC)
